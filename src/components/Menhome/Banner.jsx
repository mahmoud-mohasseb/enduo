...
// enduro images 🏍
import Img01 from "../../assets/images/enduro1.png";
import Img02 from "../../assets/images/bogdanenduro.png";
import Img03 from "../../assets/images/enduro6.png";
import Img06 from "../../assets/images/enduro7.png";
import Img07 from "../../assets/images/since_round.png";
import Img08 from "../../assets/images/drop_arrow.svg";
import Img09 from "../../assets/images/enduro8.png";
      ...
      <section className="banner_section">
        ...
        <div className="banner_side_shape">
          <div className="left_shape">
            <img src={Img01} alt="img" width={300} height={300} />
          </div>
          <div className="right_shape">
            <img src={Img02} alt="img" width={400} height={320} />
          </div>
        </div>
        <div className="container">
          <div className="banner_inner">
            <h1 data-aos="fade-up" data-aos-duration={1500}>
              Pathfinderenduro , <br />
              exploring the world of endurance sports
            </h1>
            <p className="lead" data-aos="fade-up" data-aos-duration={1500}>
              Providing an enjoyable Pathfinderenduro experience at rich
              location of Brasov!
            </p>
